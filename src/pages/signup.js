...
<button type="submit" className="p-2 mt-2" style={{background:'#06b6d4'}}>Sign up</button>
</form>
<div className="mt-4">
<button onClick={signInWithGoogle} className="p-2" style={{background:'#ef4444'}}>Sign up with Google</button>
</div>
